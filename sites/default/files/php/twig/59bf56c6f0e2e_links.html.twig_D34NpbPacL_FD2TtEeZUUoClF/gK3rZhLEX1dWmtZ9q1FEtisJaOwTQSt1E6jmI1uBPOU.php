...
/* links.html.twig */
class __TwigTemplate_cd8af5265faca47e5f9fe6b1ab9a9fd193a620ec8aed5af85ae467af09005906 extends Twig_Template
{
    ...
    protected function doDisplay(array $context, array $blocks = array())
    {
        ...
        if ((isset($context["links"]) ? $context["links"] : null)) {
            ...
            // line 42
            echo "<ul";
            echo $this->env->getExtension('sandbox')->ensureToStringAllowed($this->env->getExtension('drupal_core')->escapeFilter($this->env, $this->getAttribute((isset($context["attributes"]) ? $context["attributes"] : null), "addClass", array(0 => "w3-ul"), "method"), "html", null, true));
            echo ">";
            // line 43
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["item"]) {
                // line 44
                echo "<li";
                echo $this->env->getExtension('sandbox')->ensureToStringAllowed($this->env->getExtension('drupal_core')->escapeFilter($this->env, $this->getAttribute($this->getAttribute($context["item"], "attributes", array()), "addClass", array(0 => "w3-left w3-small"), "method"), "html", null, true));
                echo ">";
                // line 45
...
{% if links -%}
  {%- if heading -%}
    ...
    {%- endif -%}
  {%- endif -%}
  <ul{{ attributes.addClass('w3-ul') }}>
    {%- for item in links -%}
      <li{{ item.attributes.addClass('w3-left w3-small') }}>
        {%- if item.link -%}
          {{ item.link }}
